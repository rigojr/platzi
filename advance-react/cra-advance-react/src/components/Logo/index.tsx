  ...
  return (
    <Link to={'/'}>
      <SvgContainer>
        ...
        >
          <defs>
            <linearGradient id="prefix__editing-stripes-gradient" x1={0.043} x2={0.957} y1={0.297} y2={0.703}>
              <stop offset={0} stopColor="#434099" />
              <stop offset={1} stopColor="#e00" />
            </linearGradient>
            <filter id="prefix__editing-stripes" x="-100%" y="-100%" width="300%" height="300%">
              <feFlood result="color" floodColor="red" />
              <feImage
                // eslint-disable-next-line
                xlinkHref="data:image/svg+xml;base64,"
                width={2000}
                height={1000}
                result="image"
              />
